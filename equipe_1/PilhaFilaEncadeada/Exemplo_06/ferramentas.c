...
void liberaFilaDePilha(FilaDePilhas* fila){
    ...
    while(removeFilaDePilha(&aux, fila));

}

void iniPilhaDeFilas(PilhaDeFilas* pilha){
    pilha->topo = NULL;
}

int inserePilhaDeFilas(TFilaEncAlunos* fila, PilhaDeFilas* pilha){
...
int removePilhaDeFilas(TFilaEncAlunos* fila, PilhaDeFilas* pilha){

    TFilaEncAlunos* aux = pilha->topo;
...
void imprimePilhaDeFilas(PilhaDeFilas* pilha){
...
void liberaPilhaDeFilas(PilhaDeFilas* pilha){
    TFilaEncAlunos fila;

    while(removePilhaDeFilas(&fila, pilha));
}
