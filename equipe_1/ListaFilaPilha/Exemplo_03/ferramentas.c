...
void colocaPilhaFila(TListAlunos* alunos, TPilhaAlunos* palunos, TFilaAlunos* falunos){
    TAluno aux;
    for(int i = 0; i < LSIZE; i++){ //Vou percorrer a lista inteira
        if((alunos->lista[i].numMatricula / 10000) == 20211) //Verifico se o aluno é calouro
