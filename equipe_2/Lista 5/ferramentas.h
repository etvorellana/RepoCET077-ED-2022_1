...
PRaizArvAluno criarArvoreDeLista(TListAlunos listaS); //aleatorio
PRaizArvAluno criarArvoreDeLista_C(TListAlunos listaS); // incluir binario comentado
PRaizArvAluno criarArvoreDeLista_(TListAlunos listaS); // incluir binario
...
void printArvoreAVL(PRaizArvAlunoAVL raiz, int modo);
PRaizArvAlunoAVL buscaArvoreAVLDeLista_(PRaizArvAlunoAVL raiz, int nMatricula);
/*
